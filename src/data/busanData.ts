...
export const REGIONS: Record<string, RegionInfo> = {
  ...
  north: {
    ...
    name: '북부 구역 (생태&관문)',
    emoji: '🦆',
    description: '강서구, 북구, 사상구 지역으로, 낙동강 에코 벨트를 따라 광밀하게 조성된 광활한 을숙도 갈대밭, 대저·삼락 생태공원, 화명수목원 등 부산 전체 구역 중에서도 생태 환경 및 자연 친화적인 탐방 명소가 가장 밀집한 친환경 생태 거점 구역입니다.',
  ...
  west: {
    ...
    name: '서부 구역 (노을&예술)',
    emoji: '🌅',
    description: '사하구, 서구 지역으로 다대포의 황홀한 노을 낙조, 암남공원과 화목한 소나무 숲길, 천마산 산허리 전망대, 그리고 송도 지질 탐방로가 거친 해변 절벽과 어우러져 수려한 자연 경관과 해양 예술의 낭만을 오롯이 만끽할 수 있는 구역입니다.',
    districts: ['사하구', '서구']
  },
  south: {
    key: 'south',
    name: '남부 구역 (역사&원도심)',
    emoji: '⚓',
    description: '중구, 동구, 영도구, 남구 지역으로 우뚝 솟은 부산타워, 피란 시절의 이야기를 품은 초량 168계단, 소막피란역사관, 보수동 책방골목 등 부산 근현대 역사 테마가 가장 짙게 우러나와 구도심의 유구한 애환과 발자취를 배우는 역사 탐업 구역입니다.',
  ...
  haeundae: {
    ...
    name: '해운대 구역 (세계&관광)',
    emoji: '🏙️',
    description: '해운대구 중심 구역으로 시원하게 트인 명품 모래사장 해수욕장, 센텀시티, 벡스코 분수광장, 영화의전당 등 전 세계 탑클래스 수준의 현대식 엔터테인먼트와 레저, 다양한 즐길 거리가 밀도 높게 모인 도심형 월드 투어 존입니다.',
    districts: ['해운대구']
  },
  dongnae: {
    key: 'dongnae',
    name: '동래 구역 (전통&교육)',
    emoji: '⛩️',
    description: '동래구, 금정구, 연제구, 부산진구 지역으로 유서 깊은 동래읍성, 금정산성 관문 등 유구한 학술 문화재가 온천천 시민 냇길 및 중심 서면역 환승로와 연계되어 배움과 전통 역사가 깊이 서려 있는 교육·행정 구역입니다.',
  ...
  gijang_suyeong: {
    ...
    name: '기장·수영 구역 (자연&여가)',
    emoji: '⛵',
    description: '기장군, 수영구 지역으로 삼익비치 오션 갈맷길, 일광·임랑의 한적한 해풍 바다, 기장 수평 갈대숲과 함께 대게, 전복죽, 활어 회타운 등 다채롭고 싱싱한 향토 미식과 힐링 자연 여가가 활짝 숨 쉬는 여유 해안 구역입니다.',
    districts: ['기장군', '수영구']
  }
};
